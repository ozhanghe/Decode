...
public class Park {
    ...
    private final double threshold = Math.PI / 12; // idk tune

    public static PID bellypanPID = new PID (0.0, 0.0002, 0.0001);
    ...
    public Park(Robot robot) {
        ...
        pivot = new PriorityCRServo(
                new CRServo[]{robot.hardwareMap.get(CRServo.class, "right_pivot"),
                        robot.hardwareMap.get(CRServo.class,"left_pivot")},
                "pivot", PriorityCRServo.ServoType.AXON_MAX,
                new boolean[]{true, false}, 2, 5);
    ...
    public void update() {
        ...
        power = bellypanPID.update((target_angle - angle) / gear_ratio, -1, 1);
    ...
    public double getBellypanAngle() {
        return sensors.getParkAngleTraveled() * gear_ratio;
    }
